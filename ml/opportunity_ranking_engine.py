...
def regime_score(market_regime):
    ...
    if market_regime == "VOLATILE_MOMENTUM":
        return 0.5
...
def main():
    ...
    cursor.execute("""
    DROP TABLE IF EXISTS opportunity_ranking_engine;
    """)
    ...
    for row in rows:
        ...
        normalized_regime = regime_score(
            market_regime
        )
        ...
        if (
            ...
            and
            opportunity_score >= BUY_SCORE_THRESHOLD
        ):
            recommendation = "BUY"
